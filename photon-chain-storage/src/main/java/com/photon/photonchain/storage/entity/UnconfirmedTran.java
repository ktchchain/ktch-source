...
public class UnconfirmedTran implements Comparable<UnconfirmedTran>,Serializable {
    ...
    private int contractType;//0 非合约 1挂单合约 2.投票合约 3.代币合约
    ...
    @Transient
    private String transSignatureStr;

    public String getTransSignatureStr() {
        return transSignatureStr;
    }

    public void setTransSignatureStr(String transSignatureStr) {
        this.transSignatureStr = transSignatureStr;
    }
}